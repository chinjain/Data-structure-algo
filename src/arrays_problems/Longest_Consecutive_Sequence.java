...
//		bruteForce(a);
	 ...
	 * 
	 * int n = a.length; int longest = 1;
	 * 
	 * for (int i = 0; i < a.length; i++) { int x = a[i]; int cnt = 1;
	 * 
	 * while (linearSearch(a, x + 1)) { x += 1; cnt += 1; }
	 * 
	 * longest = Math.max(longest, cnt);
	 * 
	 * }
	 ...
	 * 
	 * for (int j = 0; j < a.length; j++) { if (a[i] == i) { return true; } }
	 * 
	 * return false; }
	 */
